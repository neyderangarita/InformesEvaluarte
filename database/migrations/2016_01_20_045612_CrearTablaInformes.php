...
class CrearTablaInformes extends Migration {
	...
	public function up()
	{
		Schema::create('informes', function(Blueprint $table)
		{
			...
			$table->string('Componentes1Mat1', 50);
			$table->string('Componentes2Mat1', 50);
			$table->string('Componentes3Mat1', 50);
			$table->string('Competencia1Mat1', 50);
			$table->string('Competencia2Mat1', 50);
			$table->string('Competencia3Mat1', 50);
			$table->string('Componentes1Mat2', 50);
			$table->string('Componentes2Mat2', 50);
			$table->string('Componentes3Mat2', 50);
			$table->string('Componentes4Mat2', 50);
			$table->string('Competencia1Mat2', 50);
			$table->string('Competencia2Mat2', 50);
			$table->string('Competencia3Mat2', 50);
			$table->string('Competencia1Mat4', 50);
			$table->string('Competencia2Mat4', 50);
			$table->string('Competencia3Mat4', 50);
			$table->string('Competencia1Mat5', 50);
			$table->string('Competencia2Mat5', 50);
			$table->string('Competencia3Mat5', 50);
