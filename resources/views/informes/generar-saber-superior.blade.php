<html lang="en">
    ...
    <body>
        <div style="text-align: center; font: 70%; font-family: Geneva, Cambria, monospace, Arial, Helvetica, sans-serif">
                <img class="custom_logo ie_png"  style="position: absolute;top: 0px;left: 0px;width: auto;" src="/imagenes/fondo-saber-superior.png">    
                
                <div style="position: absolute;top: 283px;left: 95px;width: 400px;"  id="perf_div">
                ...
                <div style="position: absolute;top: 790px;left: 300px;width: 86px;">
                    <span>{{ round(($informar->proMat1 + $informar->proMat2 + $informar->proMat3 + $informar->proMat4 + $informar->proMat5)/ 5)}}<span>&nbsp;</span>
                </div>
                
                <div style="position: absolute;top: 790px;left: 560px;width: 86px;">
                    <span>
                        <?php 
