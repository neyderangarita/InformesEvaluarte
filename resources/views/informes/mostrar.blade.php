			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
					<div class="caption">	
						...
						<p><strong>Puntaje Total: </strong> {{ round(($informe->proMat4 * 3) * (5/13)) + round(($informe->proMat1 * 3) * (5/13)) + round(($informe->proMat5 * 3) * (5/13)) + round(($informe->proMat2* 3) * (5/13)) + round($informe->proMat3 * (5/13)) }}</p>				
